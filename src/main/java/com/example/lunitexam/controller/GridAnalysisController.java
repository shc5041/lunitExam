...
public class GridAnalysisController {
    ...
    public ResponseEntity<Page<GridAnalysis>> findAll(@ParameterObject @PageableDefault(sort = {"idx"}, value = 20) Pageable pageable) {
    ...
    public ResponseEntity<Page<GridAnalysis>> findByAnalysisDecisionIdx(@PathVariable Long idx, @ParameterObject @PageableDefault(sort = {"idx"}, value = 20) Pageable pageable) {
